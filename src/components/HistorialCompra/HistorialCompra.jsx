            ...
            <div>
                ...
                <nav class="pagination is-right" role="navigation" aria-label="pagination">
                    ...
                    <ul class="pagination-list">
                        { (indiceActual !== 1) && <li><button class="pagination-link" onClick={handleTargetPagina(1)}>1</button></li>}
                        { (indiceActual > 3) && <li><span class="pagination-ellipsis">&hellip;</span></li>}
                        { (indiceActual > 2) && <li><button class="pagination-link" onClick={handleTargetPagina(indiceActual -  1)}>{(indiceActual - 1)}</button></li>}
                        <li><button class="pagination-link is-current" onClick={handleTargetPagina(indiceActual)}>{indiceActual}</button></li>
                        { (indiceActual < totalPaginas - 1) && <li><button class="pagination-link" onClick={handleTargetPagina(indiceActual + 1)}>{(indiceActual + 1)}</button></li>}
                        { (indiceActual < totalPaginas - 2) && <li><span class="pagination-ellipsis">&hellip;</span></li>}
                        { (indiceActual !== totalPaginas) && <li><button class="pagination-link" onClick={handleTargetPagina(totalPaginas)}>{totalPaginas}</button></li>}
                    </ul>
                </nav>
            </div>
        </div>
